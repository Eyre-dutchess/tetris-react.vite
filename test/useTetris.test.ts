...
import { useTetris, saveHighScore, getHighScores } from '../src/hooks/useTetris';
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import { hasCollisions, useTetrisBoard } from '../src/hooks/useTetrisBoard';
...
vi.mock('../src/hooks/useTetrisBoard', async () => {
  const actual = await vi.importActual('../src/hooks/useTetrisBoard');
  return {
    ...actual,
    hasCollisions: vi.fn(),
    useTetrisBoard: () => {
